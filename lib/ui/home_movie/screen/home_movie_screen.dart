        ...
        bottomNavigationBar: ConvexAppBar(
          ...
          items: <TabItem<SvgPicture>>[
            TabItem<SvgPicture>(
              ...
              icon: ThemeIcons(color: controller.getMyColor(controller.currentIndex.value, 0)).theWatcherLogo,
            ),
            TabItem<SvgPicture>(
              title: 'movies.popular.icon'.tr,
              icon: ThemeIcons(color: controller.getMyColor(controller.currentIndex.value, 1)).theWatcherLogo,
            ),
            TabItem<SvgPicture>(
              title: 'movies.top_rated.icon'.tr,
              icon: ThemeIcons(color: controller.getMyColor(controller.currentIndex.value, 2)).theWatcherLogo,
            ),
            TabItem<SvgPicture>(
              title: 'movies.upcoming.icon'.tr,
              icon: ThemeIcons(color: controller.getMyColor(controller.currentIndex.value, 3)).theWatcherLogo,
            ),
          ],
        ),
      ),
